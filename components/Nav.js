    ...
    useEffect(() => {
      console.log(' 모듈에 저장된 로그인값: '+JSON.stringify(loginUser))
        if (loginUser === null) {
            ...
            setImageInfos({
                imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQf39BMiKd0kuYH8KzUuhdpztzubgG67rmiLA&usqp=CAU' +
                        '8x8ORLeG25en.jpg',
                imageTitle: 'sign'
            })
        } else {
            ...
            setImageInfos(
                {imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRB-4sUqvFbHsLoWK92ykXDe6f6sSITjejcpw&usqp=CAU', imageTitle: 'users'}
            )
        }
